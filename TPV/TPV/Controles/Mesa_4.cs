...
{
    public partial class Mesa_4 : UserControl
    {
        public Mesa_4()
        {
            InitializeComponent();
            ...
            this.lblCaption.Click += new EventHandler(Mesa_4_Click);
            this.img.Click += new EventHandler(Mesa_4_Click);
        ...
        public Int32 setEstado
        {
            ...
            set
            {
                ...
                {
                    case 1:
                        this.img.Image = Properties.Resources.Mesa_4;
                        this.lblCaption.BackColor = Color.FromArgb(152, 77, 42);
                        break;
                    case 2:
                        this.img.Image = Properties.Resources.Mesa_4_O;
                        this.lblCaption.BackColor = Color.FromArgb(191, 8, 17);
                        break;
                    case 3:
                        this.img.Image = Properties.Resources.Mesa_4_C;
        ...
        private void Mesa_4_Click(object sender, EventArgs e)
        {
            this.OnClick(e);
        }
    }
