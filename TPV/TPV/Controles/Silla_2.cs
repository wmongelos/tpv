...
{
    public partial class Silla_2 : UserControl
    {
        public Silla_2()
        {
            InitializeComponent();
            ...
            this.lblCaption.Click += new EventHandler(Silla_2_Click);
            this.img.Click += new EventHandler(Silla_2_Click);
        ...
        private void Silla_2_Click(object sender, EventArgs e)
        {
            this.OnClick(e);
        }
    }
