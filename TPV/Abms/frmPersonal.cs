...
namespace TPV.Abms
{
    public partial class frmPersonal : Form
    {
        ...
        {
            dt.DefaultView.RowFilter = string.Format("CONVERT(personal_id, System.String) LIKE '%{0}%' or nombre LIKE '%{0}%' or apellido LIKE '%{0}%' or telefono_1 LIKE '%{0}%' or telefono_2 LIKE '%{0}%'", txtBuscar.Text.Trim());
        }
