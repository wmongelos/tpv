...
{
    public partial class Mesa_2 : UserControl
    {
        public Mesa_2()
        {
            InitializeComponent();
            ...
            this.lblCaption.Click += new EventHandler(Mesa_2_Click);
            this.img.Click += new EventHandler(Mesa_2_Click);
        }
        ...
        public Int32 setEstado
        {
            ...
            set
            {
                ...
                {
                    case 1:
                        this.img.Image = Properties.Resources.Mesa_2;
                        this.lblCaption.BackColor = Color.FromArgb(152, 77, 42);
                        break;
                    case 2:
                        this.img.Image = Properties.Resources.Mesa_2_O;
                        this.lblCaption.BackColor = Color.FromArgb(191, 8, 17);
                        break;
                    case 3:
                        this.img.Image = Properties.Resources.Mesa_2_C;
        ...
        private void Mesa_2_Click(object sender, EventArgs e)
        {
            this.OnClick(e);
        }
    }
