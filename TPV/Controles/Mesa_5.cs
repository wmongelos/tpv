...
{
    public partial class Mesa_5 : UserControl
    {
        public Mesa_5()
        {
            InitializeComponent();
            ...
            this.lblCaption.Click += new EventHandler(Mesa_5_Click);
            this.img.Click += new EventHandler(Mesa_5_Click);
        ...
        public Int32 setEstado
        {
            ...
            set
            {
                ...
                {
                    case 1:
                        this.img.Image = Properties.Resources.Mesa_5;
                        this.lblCaption.BackColor = Color.FromArgb(152, 77, 42);
                        break;
                    case 2:
                        this.img.Image = Properties.Resources.Mesa_5_O;
                        this.lblCaption.BackColor = Color.FromArgb(191, 8, 17);
                        break;
                    case 3:
                        this.img.Image = Properties.Resources.Mesa_5_C;
        ...
        private void Mesa_5_Click(object sender, EventArgs e)
        {
            this.OnClick(e);
        }
    }
